...
use Helix\ParamResolver\Middleware\LazyObjectResolver;
 ...
 */
class LazyObjectResolverTestCase extends TestCase
{
    protected function resolver(object $target, ?string $class = null): TestingValueMiddleware
    {
