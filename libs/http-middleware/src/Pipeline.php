...
use Helix\Contracts\Http\Middleware\MutablePipelineInterface;
use Helix\Http\Middleware\Pipeline\CallableHandler;
use Helix\Http\Middleware\Pipeline\Next;
...
final class Pipeline implements MutablePipelineInterface
{
     ...
     * @return ResponseInterface
     */
    public function processToCallable(ServerRequestInterface $request, callable $handler): ResponseInterface
    {
        return $this->process($request, new CallableHandler($handler));
    }
